...
/*
    ...
    owner_address, spender_address,  recipient_address, token_addr, token_id.
*/

pub async fn safe_transferfrom(
    ...
    let signed_transaction = web3s
        .accounts()
        .sign_transaction(transact_obj, &spender_private_key) // private key should be spender
        .await
        .unwrap();
