...
/// This method returns Token increase allowance.
/*
    This function required arguments.
    owner address, private key, spender address, token address, amount.
*/
pub async fn increase_allowance(
    ...
    let amount: U256 = amount.trim().parse().expect("invalid input");
    ...
    let value: U256 = allowance + amount;
    ...
    let data = token_contract
        ...
        .function("approve")
        .unwrap()
        .encode_input(&(spender_addr, value).into_tokens())
        .unwrap();
